...
#define HOST_NEEDPOLL  0x02
#define HOST_UPDATE_LOAD  0x04
#define HOST_JOB_RESUME  0x08
#define HOST_AUTOCONF_MXJ 0x10
...
extern void                 queueHostsPF (struct qData *qp, int *);
...
extern void                 log_startjobaccept(struct jData *jPtr);
...
#if defined(INTER_DAEMON_AUTH)
extern int getDaemonAuth(struct lsfAuth *auth, char *toHost,
